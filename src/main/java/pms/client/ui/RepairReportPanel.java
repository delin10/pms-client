...
public class RepairReportPanel extends SwitchPanel {
	...
	private JLabel title = new JLabel("报修记录");
	...
	public SwitchPanel initTable() {
		Func.exec(() -> {
			UIHandler.handle_roles_table(Func.repair_reports(), table);
